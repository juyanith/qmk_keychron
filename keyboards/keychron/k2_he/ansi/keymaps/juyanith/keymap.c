...
// Runtime movement overrides are supplied by userspace introspection hooks.
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [NV_LT] = LAYOUT_ansi_84(
        ...
        KC_ENT,   KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    NV_HOME,  NV_PGDN,  NV_PGUP,  NV_END,   NV_CURS,  KC_NO,    KC_NO,              _______,
        _______,  KC_NO,    KC_NO,    KC_NO,    NV_FIND,  KC_NO,    NV_BSDL,  NV_LEFT,  KC_DOWN,  KC_UP,    NV_RGHT,  KC_GRV,             _______,            _______,
        _______,  MT_UNDO,  MT_CUT,   MT_COPY,  MT_PSTE,  NV_LOC,   KC_NO,    MT_RCTL,  MT_RSFT,  MT_RALT,  MT_RCMD,            _______,            _______,  _______,
        _______,  _______,  _______,                                _______,                                _______,  _______,  _______,  _______,  _______,  _______)
};
